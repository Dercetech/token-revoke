'use strict';
module.exports = function revokeListFactory(
		wtDone,
		//config,
		RevokeSchema){
	...
	function revokeUserBeforeNow(userToRevoke){
		// TODO inject expiration delay
		return revokeUser(userToRevoke, new Date().getTime() / 1000, revocation.revokeBefore + 60*60*24 /*config.security.jot.expiration*/);
	}
}